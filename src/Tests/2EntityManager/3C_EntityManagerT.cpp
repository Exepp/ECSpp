...
//     TComp1 tester1(TComp1::Arr_t{ 0, 1, 2 });
...
//             creator.constructed<TComp1>(tester1.copy(i));
...
//         ents.push_back(mgr.spawn(arch,
//                                  [&](EntityCreator&& creator) {
//                                      creator.constructed<TComp1>(TComp1::Arr_t{ tester1.a + i, (int)tester1.b + i, (int)tester1.c + i });
//                                  }));
//         ents.push_back(mgr.spawn(Archetype(IdOf<TComp1, TComp4>()),
//                                  [&](EntityCreator&& creator) {
//                                      creator.constructed<TComp1>(TComp1::Arr_t{ tester1.a + 2 * i, (int)tester1.b + 2 * i, (int)tester1.c + 2 * i });
...
//         Entity ent = mgr.spawn(arch,
//                                [](EntityCreator&& creator) {
//                                    creator.constructed<TComp1>(TComp1::Arr_t{ 4321, 43, 4 });
//                                });
...
//         ASSERT_EQ(TComp2::AliveCounter, 1);
//         ASSERT_TRUE(mgr.isValid(ent));
//         ASSERT_EQ(mgr.componentOf<TComp1>(ent), TComp1({ 4321, 43, 4 }));
