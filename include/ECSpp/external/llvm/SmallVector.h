...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Changed to work as a single header file - copied needed definitions, removed/replaced macros & attributes //
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
inline void* safe_malloc(size_t Sz)
{
    ...
    if (Result == nullptr) {
        ...
        EPP_ASSERTA_M(false, "Allocation failed");
    }
    return Result;
}
...
protected:
    ...
    void grow_pod(void* FirstEl, size_t MinCapacity, size_t TSize)
    {
        ...
        EPP_ASSERT_M(MinCapacity <= UINT32_MAX, "SmallVector capacity overflow during allocation");
...
{
    EPP_ASSERT_M(MinSize <= UINT32_MAX, "SmallVector capacity overflow during allocation");

    // Always grow, even from zero.
    size_t NewCapacity = size_t(NextPowerOf2(this->capacity() + 2));
    NewCapacity = std::min(std::max(NewCapacity, MinSize), size_t(UINT32_MAX));
    T* NewElts = static_cast<T*>(safe_malloc(NewCapacity * sizeof(T)));
